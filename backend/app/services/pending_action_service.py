...
class PendingActionType(str, Enum):
    ...
    SUITABLE_CREATE_ORDER_CONFIRMATION = "SUITABLE_CREATE_ORDER_CONFIRMATION"
    CRM_STAGE_MOVE_CONFIRMATION = "CRM_STAGE_MOVE_CONFIRMATION"
    GOOGLE_SHEETS_APPEND_ROW_CONFIRMATION = "GOOGLE_SHEETS_APPEND_ROW_CONFIRMATION"
    GOOGLE_SHEETS_UPDATE_ROW_CONFIRMATION = "GOOGLE_SHEETS_UPDATE_ROW_CONFIRMATION"
...
SUITABLE_CREATE_ORDER_CONFIRMATION = PendingActionType.SUITABLE_CREATE_ORDER_CONFIRMATION.value
CRM_STAGE_MOVE_CONFIRMATION = PendingActionType.CRM_STAGE_MOVE_CONFIRMATION.value
GOOGLE_SHEETS_APPEND_ROW_CONFIRMATION = PendingActionType.GOOGLE_SHEETS_APPEND_ROW_CONFIRMATION.value
GOOGLE_SHEETS_UPDATE_ROW_CONFIRMATION = PendingActionType.GOOGLE_SHEETS_UPDATE_ROW_CONFIRMATION.value
