...
def _frontend_base_url() -> str:
    ...
    if parsed.scheme not in {"http", "https"} or not parsed.netloc:
        logger.warning("GOOGLE_DRIVE_INVALID_FRONTEND_URL value=%s", configured)
...
def _redirect_uri(request: Request) -> str:
    ...
    logger.info("GOOGLE_DRIVE_REDIRECT_URI_RESOLVED redirect_uri=%s source=%s", redirect_uri, "env" if configured else "fallback")
    return redirect_uri
