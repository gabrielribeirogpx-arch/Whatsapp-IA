...
import { choiceRecordsPath, detectChoiceSchema, dynamicChoiceVariables } from '@/lib/dynamicChoice';
...
import { DATA_COLLECTION_TYPE_OPTIONS } from '@/lib/dataCollectionTypes';
...
const NODE_PRESETS: Record<FlowNodeKind, { label: string; type: string; data: Record<string, unknown> }> = {
  ...
  mcp_tool: { label: 'MCP Tool', type: 'mcp_tool', data: { connection_id: '', connection_name: '', connection_kind: '', connection_status: '', connection_verified: false, server_name: '', tool_name: '', tool_description: '', tool_risk: '', input_schema: {}, arguments: {}, arguments_mode: 'form', output_variable: '', result_path: '', timeout_seconds: 30, retry: { enabled: false, max_attempts: 2, backoff_ms: 1000 }, save_raw_response: false, allow_external_write: false, destructive_confirmed: false, is_terminal: false } },
