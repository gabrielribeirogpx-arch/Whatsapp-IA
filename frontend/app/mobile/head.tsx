export default function Head() {
  return (
    <>
      ...
      <meta name="apple-mobile-web-app-title" content="Wazza API" />
      ...
      <link rel="apple-touch-startup-image" href="/Logo.svg" media="(device-width: 430px) and (device-height: 932px) and (-webkit-device-pixel-ratio: 3)" />
    </>
  );
}
