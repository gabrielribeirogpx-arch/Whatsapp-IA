...
<div className="onboarding-fields">
  {step===1 && <><label className="onboarding-label">Nome completo</label><input className="onboarding-input" value={form.full_name} onChange={e=>setForm({...form, full_name:e.target.value})} required /><label className="onboarding-label">Email</label><input className="onboarding-input" type="email" value={form.email} onChange={e=>setForm({...form, email:e.target.value})} required /><label className="onboarding-label">Senha</label><input className="onboarding-input" type="password" minLength={8} value={form.password} onChange={e=>setForm({...form, password:e.target.value})} required /><label className="onboarding-label">Confirmar senha</label><input className="onboarding-input" type="password" minLength={8} value={form.confirm_password} onChange={e=>setForm({...form, confirm_password:e.target.value})} required /></>}
  {step===2 && <><label className="onboarding-label">Nome do negócio</label><input className="onboarding-input" value={form.business_name} onChange={e=>setForm({...form, business_name:e.target.value})} required /><label className="onboarding-label">Segmento</label><input className="onboarding-input" value={form.business_segment} onChange={e=>setForm({...form, business_segment:e.target.value})} required /><label className="onboarding-label">Tamanho do time (opcional)</label><input className="onboarding-input" value={form.team_size} onChange={e=>setForm({...form, team_size:e.target.value})} /></>}
  {step===3 && <><label className="onboarding-label">Número WhatsApp</label><input className="onboarding-input" value={form.whatsapp_number} onChange={e=>setForm({...form, whatsapp_number:e.target.value})} required /><label className="onboarding-label">Volume mensal (opcional)</label><input className="onboarding-input" value={form.monthly_message_volume} onChange={e=>setForm({...form, monthly_message_volume:e.target.value})} /><label className="onboarding-label">Uso pretendido</label><input className="onboarding-input" value={form.intended_use} onChange={e=>setForm({...form, intended_use:e.target.value})} required /></>}
