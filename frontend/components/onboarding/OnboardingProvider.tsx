...
const initialState: TutorialState = { currentStep: 0, missionStatus: {}, completed: [], dismissedScreens: [], tourDismissed: false, completionNoticeShown: false };
...
export function OnboardingProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    setState(old => ({ ...old, completionNoticeShown: true }));
