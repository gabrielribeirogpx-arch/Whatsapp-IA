  ...
  return (
    <section className='w-full min-w-0 px-4 py-5 sm:px-6 lg:px-8'>
      <div className='mx-auto flex w-full max-w-7xl flex-col gap-4'>
        {activeTab !== 'billing' && <header className='relative overflow-hidden rounded-3xl border border-[color:var(--surface-border)] bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 p-6 text-white shadow-[0_24px_60px_-38px_rgba(2,6,23,0.9)] md:p-8'>
