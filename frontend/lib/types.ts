...
export type WhatsAppTemplate = { id:string; name:string; status:string; language:string; category?:string|null; body_text:string; body_raw_meta?: string; body_preview?: string | null; rejection_reason?: string | null; variables_json?: Array<{ position:number; key:string; label:string; example:string }> | null };
